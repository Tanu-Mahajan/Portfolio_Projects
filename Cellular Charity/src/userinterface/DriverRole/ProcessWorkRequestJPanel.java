...
public class ProcessWorkRequestJPanel extends javax.swing.JPanel {
    ...
    public ProcessWorkRequestJPanel(JPanel userProcessContainer, MobileWorkRequest request, UserAccount account, Network network) {
        initComponents();
    ...
    private void btnSubmitResultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitResultActionPerformed
        ...
        if (!resFlag){
            ...
            request.setStatus("Mobile Delivered");        
                    ...
                    for(Organization o: e.getOrganizationDirectory().getOrganizationList()) {
                     // if(request.getSender().equals(o))
                        if(o instanceof RetailChain)
                       {
                        ...
                        if(o instanceof Inventory && request.getSenderOrganization() instanceof HeadOffice) {
