...
public class OfficeManagerWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public OfficeManagerWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, HeadOffice organization, Enterprise enterprise, EcoSystem business, Network network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        mainOfficeJTable.setBackground(new java.awt.Color(204, 255, 204));
        mainOfficeJTable.setFont(new java.awt.Font("Lucida Calligraphy", 0, 12)); // NOI18N
        mainOfficeJTable.setForeground(new java.awt.Color(51, 0, 51));
    ...
    private void btnRequestWorkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestWorkActionPerformed
        ...
        if (selectedRow >= 0) {
            MobileWorkRequest request = (MobileWorkRequest) mainOfficeJTable.getValueAt(selectedRow, 0);
            if(!request.getStatus().equalsIgnoreCase("Mobile Delivered")){
