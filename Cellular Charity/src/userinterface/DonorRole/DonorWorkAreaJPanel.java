...
public class DonorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Wish to donate Mobile? Just notify us!");

        donateBtn.setBackground(new java.awt.Color(204, 255, 204));
        donateBtn.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        donateBtn.setForeground(new java.awt.Color(51, 0, 51));
        ...
        locationTxt.setBackground(new java.awt.Color(204, 255, 204));
        locationTxt.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        locationTxt.setForeground(new java.awt.Color(51, 0, 51));
        ...
        storeComboBox.setBackground(new java.awt.Color(204, 255, 204));
        storeComboBox.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        storeComboBox.setForeground(new java.awt.Color(51, 0, 51));
    ...
    private void donateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_donateBtnActionPerformed
        ...
        if (!userAccount.getDonor().getType().equalsIgnoreCase("Individual")) {
            ...
            if (!qtyFlag & !locFlag){
                for (Donor donor : business.getDonorDirectory().getDonorList()) {
                ...
                request.setMessage("Mobile ready for pickup");
                ...
                for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                    ...
                    if (enterprise instanceof CentralHubEnterprise) {
                        ...
                        for (Organization organization : en.getOrganizationDirectory().getOrganizationList()) {
                            ...
                            if (organization instanceof HeadOffice) {
                        ...
                        if (org != null) {
                            ...
                            JOptionPane.showMessageDialog(null, "Mobile donated successfully.");
                            quantityTxt.setText("");
                            locationTxt.setText("");
                        }
            ...
            if (!qtyFlag){
                ...
                request.setStatus("Mobile Received");
                request.setMessage("Mobile given at store");
                Store inStore = null;
                for(Network network: business.getNetworkList()){
                     String net=(String)comboBoxCity.getSelectedItem();
                    if(network.getName().equalsIgnoreCase(net)){
