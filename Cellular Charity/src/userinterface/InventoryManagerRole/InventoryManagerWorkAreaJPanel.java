...
public class InventoryManagerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void populateRequestTable(){
        ...
        for (WorkRequest request : organization.getWorkQueue().getWorkRequestList()){
            ...
            row[2] = quantity;
            String location = ((MobileWorkRequest) request).getLocation();
            row[3] = location;
    ...
    private void initComponents() {
        ...
        tblInventory.setBackground(new java.awt.Color(204, 255, 204));
        tblInventory.setForeground(new java.awt.Color(51, 0, 51));
        ...
        btnRequestWork.setBackground(new java.awt.Color(204, 255, 204));
        btnRequestWork.setForeground(new java.awt.Color(51, 0, 51));
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        if (selectedRow >= 0) {
            MobileWorkRequest request = (MobileWorkRequest) tblInventory.getValueAt(selectedRow, 0);
    ...
    private void btnGiveAwayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGiveAwayActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Mobile Successfully donated to NGOs and Old-Aged Homes");
        }
