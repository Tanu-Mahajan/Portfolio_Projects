...
public class RequestTestJPanel extends javax.swing.JPanel {
     ...
     */
    public RequestTestJPanel(JPanel userProcessContainer, Logistics organization, MobileWorkRequest request, UserAccount userAccount, EcoSystem business, Network network) {
        initComponents();
    ...
    public void populateDriverComboBox() {
       ...
       // for(Network n : business.getNetworkList()){
            ...
            for(Enterprise e : network.getEnterpriseDirectory().getEnterpriseList()){
                if(e instanceof LogisticsNexusEnterprise)
                {
                    en=e;
    ...
    private void initComponents() {
        ...
        txtLocation.setBackground(new java.awt.Color(204, 255, 204));
        txtLocation.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        txtLocation.setForeground(new java.awt.Color(51, 0, 51));
