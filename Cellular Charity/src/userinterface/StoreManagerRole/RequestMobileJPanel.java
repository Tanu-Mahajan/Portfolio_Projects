...
public class RequestMobileJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form RequestMobileJPanel
     */
    public RequestMobileJPanel(JPanel userProcessContainer, UserAccount account, Store organization, Enterprise enterprise, EcoSystem business, Network network) {
        initComponents();
...
//        populatestoreTable();
    ...
    private void initComponents() {
        ...
        tblStores.setBackground(new java.awt.Color(204, 255, 204));
        tblStores.setFont(new java.awt.Font("Lucida Calligraphy", 0, 12)); // NOI18N
        tblStores.setForeground(new java.awt.Color(51, 0, 51));
        ...
        quantityTxt.setForeground(new java.awt.Color(51, 0, 51));
        ...
        requestBtn.setBackground(new java.awt.Color(204, 255, 204));
        requestBtn.setForeground(new java.awt.Color(51, 0, 51));
        ...
        btnRequestInventory.setBackground(new java.awt.Color(204, 255, 204));
        btnRequestInventory.setForeground(new java.awt.Color(51, 0, 51));
...
//            row[3] = ((MobileWorkRequest) request).getQuantity();
//
...
//    }
    ...
    private void requestBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestBtnActionPerformed
        ...
        if (!qtyFlag){
            MobileWorkRequest request = new MobileWorkRequest();
            request.setMessage("Request for Mobile");
...
//    public void populateRequestTable(MobileWorkRequest request, Store store) {
//
