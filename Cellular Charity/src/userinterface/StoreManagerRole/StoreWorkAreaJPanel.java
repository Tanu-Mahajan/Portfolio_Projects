...
public class StoreWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public StoreWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Store organization, Enterprise enterprise, EcoSystem business, Network network) {
        ...
        if (Integer.parseInt(txtStock.getText()) < 5) {
            btnRequestMobile.setEnabled(true);
        }
    ...
    private void initComponents() {
        ...
        btnRequestMobile = new javax.swing.JButton();
        ...
        tblStore.setBackground(new java.awt.Color(204, 255, 204));
        ...
        btnRequestMobile.setBackground(new java.awt.Color(204, 255, 204));
        btnRequestMobile.setForeground(new java.awt.Color(51, 0, 51));
        btnRequestMobile.setText("Request Mobile");
        btnRequestMobile.setEnabled(false);
        btnRequestMobile.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRequestMobileActionPerformed(evt);
            }
        });

        btnAdd.setBackground(new java.awt.Color(204, 255, 204));
        btnAdd.setForeground(new java.awt.Color(51, 0, 51));
        btnAdd.setText("Add Mobile");
        ...
        txtStock.setForeground(new java.awt.Color(51, 0, 51));

        btnSend.setBackground(new java.awt.Color(204, 255, 204));
        btnSend.setForeground(new java.awt.Color(51, 0, 51));
        btnSend.setText("Send Mobile");
        ...
        txtGiveAway.setBackground(new java.awt.Color(204, 255, 204));
        txtGiveAway.setForeground(new java.awt.Color(51, 0, 51));

        btnGiveAway.setBackground(new java.awt.Color(204, 255, 204));
        btnGiveAway.setForeground(new java.awt.Color(51, 0, 51));
        ...
        btnDailySub.setBackground(new java.awt.Color(204, 255, 204));
        btnDailySub.setForeground(new java.awt.Color(51, 0, 51));
        ...
        txtQuantity.setForeground(new java.awt.Color(51, 0, 51));
    ...
    private void btnRequestMobileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestMobileActionPerformed
        // TODO add your handling code here:
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("RequestMobileJPanel", new RequestMobileJPanel(userProcessContainer, userAccount, organization, enterprise, business, network));
        layout.next(userProcessContainer);
    }//GEN-LAST:event_btnRequestMobileActionPerformed
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (selectedRow >= 0) {
            MobileWorkRequest request = (MobileWorkRequest) tblStore.getValueAt(selectedRow, 0);

            if (request.getMessage().equalsIgnoreCase("Mobile given at store")) {
...
//               {
//                   
//                request1.setStatus("Mobile Sent");
...
//           }
            ...
            if (request.getMessage().equalsIgnoreCase("Request for Mobile")) {
                if (request.getStatus().equalsIgnoreCase("Request Sent") || request.getStatus().equalsIgnoreCase("Mobile Request Partially Completed")) {
                    if (!txtQuantity.getText().isEmpty() && Validations.isDigit(txtQuantity.getText())) {
                        if ((organization.getStock() - Integer.parseInt(txtQuantity.getText())) > 10) {
                            //request.setStatus("Mobile Sent for delivery");
                            ...
                            if (quantity < requestQuantity) {
                                request.setStatus("Mobile Request Partially Completed");
                            } else {
                                request.setStatus("Mobile Sent for delivery");
                            }
                            txtStock.setText(Integer.toString(total));
                            JOptionPane.showMessageDialog(null, "Mobile request accepted");
                            populateRequestTable();
                            MobileWorkRequest trasnportRequest = new MobileWorkRequest();
                        ...
                        JOptionPane.showMessageDialog(null, "Please enter a valid quantity to send Mobile");
                    }
                } else {
                    JOptionPane.showMessageDialog(null, "Request already processed by another store.");
                }
            } else {
                JOptionPane.showMessageDialog(null, "Invalid action. You cannot send mobile for this request.");
            }
        } else {
    ...
    private void btnGiveAwayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGiveAwayActionPerformed
        ...
        if (count < 0) {
            ...
            JOptionPane.showMessageDialog(null, "Mobile Successfully donated");
        }
    ...
    private void btnDailySubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDailySubActionPerformed
        ...
        if (ans == 0) {
            ...
            records.setMobileDonated(finalStock);
            records.setMobileGiven(giveAwaycount);
    ...
    private javax.swing.JButton btnRequestMobile;
