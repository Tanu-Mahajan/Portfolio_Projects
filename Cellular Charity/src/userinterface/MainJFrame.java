...
//        Date date = new Date();
    ...
    private void initComponents() {
        ...
        btnAnalysis.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        jLabel6.setText("Welcome to Cellular Charity!!");
                ...
                for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                    ...
                    if (userAccount == null) {
                        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
                            if (organization instanceof RetailChain) {
                                ...
                                for (Store store : ((RetailChain) organization).getStoreChain()) {
