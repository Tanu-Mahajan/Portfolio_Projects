...
public class RecycleManagerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public RecycleManagerWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, ScrapPoint organization, EcoSystem business, Network network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblRecycleManager.setBackground(new java.awt.Color(204, 255, 204));
        tblRecycleManager.setFont(new java.awt.Font("Lucida Calligraphy", 0, 12)); // NOI18N
        tblRecycleManager.setForeground(new java.awt.Color(51, 0, 51));
        ...
        txtItemsComposed.setBackground(new java.awt.Color(204, 255, 204));
        txtItemsComposed.setFont(new java.awt.Font("Lucida Calligraphy", 0, 12)); // NOI18N
        txtItemsComposed.setForeground(new java.awt.Color(51, 0, 51));

        btnDaily.setBackground(new java.awt.Color(204, 255, 204));
        btnDaily.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnDaily.setForeground(new java.awt.Color(51, 0, 51));
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        if (selectedRow >= 0) {
            MobileWorkRequest request = (MobileWorkRequest) tblRecycleManager.getValueAt(selectedRow, 0);
    ...
    private void btnDailyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDailyActionPerformed
        ...
        if (ans == 0) {
            ...
            records.setMobileDecomposed(finalItemsDecomposed);
