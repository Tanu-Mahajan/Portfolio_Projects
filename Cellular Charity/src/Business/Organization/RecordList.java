...
public class RecordList {
    ...
    //returns the amount of Mobile donated by the donors for a particular month
    public int totalDonation(int month){
        ...
        for(Records record: recordList)
        {
          ...
          {
            totalDonation+=record.getMobileDonated();
          }
        }   
    ...
    //returns the amount of Mobile donated by the donors
    ...
    public int totalDecomposition(){
        ...
        for(Records record: recordList)
        {
           totalDecomposition+=record.getMobileDecomposed();
        }   
        
        return totalDecomposition;
    }
    
    //returns the amount of Mobile given avay to needy for a particular month
    public int totalGiveAway(int month){
        ...
        for(Records record: recordList)
        {
          ...
          if(record.getRequestDate().getMonth()==month)
          {
            ...
            totalGiveAway+=record.getMobileGiven();
          }
        }   
